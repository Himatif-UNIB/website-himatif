...
<div class="flex flex-wrap justify-center">
    ...
    <div class="bg-card-color border-2 cursor-pointer hover:border-gray-400
                                    ...
                                    justify-center items-center m-3 structure @if ($data['position']->division_id != NULL) modal-open @endif" data-division-id="{{ $data['position']->division_id }}">
        <div class="lg:w-64 lg:h-64">
            <div class="flex justify-center">
                @isset($data['user']->media[0])
                <img src="{{ $data['user']->media[0]->getFUllUrl() }}" alt="" class="rounded-full" style="width: 200px">
                @else
            ...
            <div class="flex justify-between items-center mt-5">
                ...
                <div class="flex space-x-3 ">
                    <span>
                        <svg class="fill-current text-white" width="20" height="20" xmlns="http://www.w3.org/2000/svg"
