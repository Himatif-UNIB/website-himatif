...
<head>
    ...
    <link href="{{ asset('assets/themes/cooming-soon/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex flex-column align-items-center">
            ...
            <div class="social-links text-center">
                <a target="_blank" href="https://twitter.com/himatif_unib" class="twitter"><i class="bi bi-twitter"></i></a>
                <a target="_blank" href="https://www.facebook.com/himatifunibofficial/" class="facebook"><i class="bi bi-facebook"></i></a>
                <a target="_blank" href="https://www.instagram.com/himatifunib/?hl=en" class="instagram"><i class="bi bi-instagram"></i></a>
                <a target="_blank" href="https://www.youtube.com/channel/UC3qn66dHS-8-VCJ5FpBMoVw" class="youtube"><i class="bi bi-youtube"></i></a>
            </div>
