...
@push('custom_js')
    ...
    <script>
        let categoryTable = $('#categories-table').DataTable({
            ajax: {
                url: '{{ route('api.gallery.categories.index') }}',
                headers: {
        ...
        addCategoryForm.addEventListener('submit', function(e) {
            ...
            if (addCategoryNameInput != '') {
                ...
                fetch('{{ route('api.gallery.categories.store') }}', {
                            method: 'POST',
                            headers: {
                                'Authorization': `Bearer ${passportAccessToken}`,
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            fetch(`{{ route('api.gallery.categories.show', false) }}/${id}`, {
                    headers: {
                        'Authorization': `Bearer ${passportAccessToken}`
                    }
                })
        ...
        editCategoryForm.addEventListener('submit', function(e) {
            ...
            fetch(`{{ route('api.gallery.categories.update', false) }}/${edit_id}`, {
                    method: 'PUT',
                    headers: {
                        'Authorization': `Bearer ${passportAccessToken}`,
                        'Content-Type': 'application/json'
        ...
        deleteBtn.addEventListener('click', function (e) {
            ...
            fetch(`{{ route('api.gallery.categories.destroy', false) }}/${delete_id}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${passportAccessToken}`
                }
