...
@section('title', 'Edit Posting: '. $post->title)
            ...
            <div class="row layout-top-spacing" id="cancel-row">
                ...
                <div class="col-xl-8 col-lg-8 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <textarea name="content" id="content-editor">{{ old('content', $post->content) }}</textarea>
                    ...
                    <div class="widget-content widget-content-area br-6 mt-2">
                        <div class="form-group">
                            ...
                            <textarea name="excerpt" id="excerpt" class="form-control" maxlength="255">{{ old('excerpt', $post->excerpt) }}</textarea>
                    ...
                    <div class="widget-content widget-content-area br-6 mt-2">
                        <div id="iconsAccordion" class="accordion-icons">
                                        ...
                                        <div class="custom-file-container form-group" data-upload-id="picture">
                                            ...
                                            <label class="custom-file-container__custom-file">
                                                <input type="file" name="picture"
                                                    class="@error('picture') is-invalid @enderror custom-file-container__custom-file__custom-file-input" accept="image/*">
                                            ...
                                            <div class="n-chk">
                                                <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                                                    <input type="checkbox" class="new-control-input" name="categories[]"
                                                        value="{{ $item->id }}"
                                                        @if (in_array($item->id, $postCategories)) checked @endif>
                            ...
                            <div class="card">
                                <div class="card-header" id="...">
                                    <section class="mb-0 mt-0">
                                        <div role="menu" class="" data-toggle="collapse" data-target="#iconAccordionThree"
                                            aria-expanded="false" aria-controls="iconAccordionThree">
                                            <div class="accordion-icon">
                                                ...
                                                <div class="col-3">
                                                    <label class="switch s-icons s-outline s-outline-success mr-2">
                                                        <input type="checkbox" name="allow_comment" value="1"
                                                            @if ($post->allow_comment == 1) checked @endif>
                                                ...
                                                <div class="col-3">
                                                    <label class="switch s-icons s-outline s-outline-info mr-2">
                                                        <input type="checkbox" name="moderate_comment" value="1"
                                                            @if ($post->moderate_comment == 1) checked @endif>
                                                        <span class="slider round"></span>
                                                    </label>
                                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="publish-collapse">
                                    <section class="mb-0 mt-0">
                                        <div role="menu" class="collapsed" data-toggle="collapse"
                                ...
                                <div id="iconAccordionPublish" class="collapse" aria-labelledby="publish-collapse"
                                    data-parent="#iconsAccordion">
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        @else
                                            <input type="submit" value="Simpan" name="save" class="btn btn-primary btn-md">
                                        @endif
                                    </div>
                                </div>
                            </div>
...
@push('custom_js')
    ...
    <script>
        ClassicEditor
            ...
            var upload = new FileUploadWithPreview("picture", {
