...
@section('title', 'Manajemen Kategori Blog')
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 mb-3">
                <div class="widget-content widget-content-area">
                    <h3>
                        ...
                        @if (current_user_can('create_blog_category'))
...
@section('custom_html')
    ...
    @if (current_user_can('update_blog_category'))
    ...
    @if (current_user_can('delete_blog_category'))
...
@push('custom_js')
    ...
    <script>
        let categoryTable = $('#categories-table').DataTable({
            ajax: {
                url: '{{ route('api.blog.blog_category.index') }}',
                headers: {
            ...
            columns: [
                ...
                },
                {
                    data: function (data, type, row) {
                        let url = `{{ config('app.url') }}/blog/category/${data.id}-${data.slug}/`;
        ...
        addCategoryForm.addEventListener('submit', function(e) {
            ...
            if (addCategoryNameInput != '') {
                ...
                fetch('{{ route('api.blog.blog_category.store') }}', {
                            method: 'POST',
                            headers: {
                                'Authorization': `Bearer ${passportAccessToken}`,
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            fetch(`{{ route('api.blog.blog_category.show', false) }}/${id}`, {
                    headers: {
                        'Authorization': `Bearer ${passportAccessToken}`
                    }
                })
        ...
        editCategoryForm.addEventListener('submit', function(e) {
            ...
            fetch(`{{ route('api.blog.blog_category.update', false) }}/${edit_id}`, {
                    method: 'PUT',
                    headers: {
                        'Authorization': `Bearer ${passportAccessToken}`,
                        'Content-Type': 'application/json'
        ...
        deleteBtn.addEventListener('click', function (e) {
            ...
            fetch(`{{ route('api.blog.blog_category.destroy', false) }}/${delete_id}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${passportAccessToken}`
                }
            ...
            .then(res => {
                if (res.success) {
                    ...
                    $('#delete-modal').on('hidden.bs.modal', function(e) {
                        deleteMessageContainer.innerHTML = `Yakin ingin menghapus kategori? Semua posting dalam kategori ini akan ditandai sebagai "<b>Tidak Berkategori</b>"`;
