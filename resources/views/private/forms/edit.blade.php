                ...
                <form action="{{ route('admin.forms.update', $form->id) }}" method="post">
                            ...
                            <div class="collapse" id="form-identity">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        value="{{ old('title', $form->title) }}" id="title" name="title"
                                        required="required" maxlength="255" minlength="4">
                            ...
                            <div class="widget-content widget-content-area br-6 container-{{ $item->id }} field-container mb-2"
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control field-question"
                                            id="question-{{ $item->id }}" name="question[{{ $item->id }}][title]"
                                        ...
                                        @foreach (json_decode($item->multiple_options) as $option)
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text"
                                                        name="question[{{ $item->id }}][multiple_options][]"
                                                        class="form-control" value="{{ $option }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">
                                                            <button type="button" data-number="1"
                                                                data-id="{{ $item->id }}"
                                                                class="btn btn-primary btn-sm add-radio-btn"><i
                                                                    class="fa fa-plus"></i>
                                                            </button>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control"
                                                        name="question[{{ $item->id }}][file_mimes]"
                                                        value="{{ $mimes }}">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        name="question[{{ $item->id }}][file_max_size]"
                                                        value="{{ $maxSize }}">
                                                    <div class="text-muted">
                                                        Masukkan dalam ukuran KB. Kosongkan untuk tidak membatasi ukuran
                                                        maksimal
                                                        file
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 mt-2">
                                        <div class="text-right">
                                            <div class="form-group">
                                                <input type="checkbox" name="question[{{ $item->id }}][is_required]"
                                                    @if ($item->is_required == 1) checked="checked" @endif id=""
                                                    value="1">
                    ...
                    @else
                        <div class="widget-content widget-content-area br-6 container-0 field-container mb-2" data-id="0">
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <label for="question-0">Pertanyaan: <span
                                            class="text-danger font-weight-bold">*</span></label>
                                    <input type="text" class="form-control field-question" id="question-0"
                                        name="question[0][title]" value="{{ old('question[0][title]') }}"
                                        required="required">
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <label for="type-0">Jenis pertanyaan:</label>
