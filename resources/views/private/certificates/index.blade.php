                    ...
                    <div class="p-3 shadow-sm mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <form action="{{ route('admin.certificates.delete', $item->id) }}" method="POST">
                                    @csrf
                                    @method("DELETE")
                                    <button type="submit" style="background: none; color: inherit; border: none;" onclick="return confirm('Apakah anda yakin ingin menghapus job ini?')">
