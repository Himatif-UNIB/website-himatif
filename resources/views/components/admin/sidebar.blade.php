    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ __active('PermissionController', ['permissions', 'edit']) }}">
                <a href="{{ route('admin.users.permissions') }}" aria-expanded="{{ __displayAria('PermissionController', ['permissions', 'edit']) }}" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ __active('UserController') }}">
                <a href="{{ route('admin.users.index') }}" aria-expanded="{{ __displayAria('UserController') }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
                            <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                            <circle cx="9" cy="7" r="4"></circle>
            ...
            @if (current_user_can(['create_blog_post', 'read_blog_post', 'update_blog_post', 'delete_blog_post'])
                ...
                @if (current_user_can(['create_blog_comment', 'read_blog_comment', 'update_blog_comment', 'delete_blog_comment']))
                    <li class="menu {{ __active('CommentController') }}">
                        <a href="{{ route('admin.blog.comments.index') }}" aria-expanded="{{ __displayAria('CommentController') }}" class="dropdown-toggle">
                            <div class="">
            ...
            @if (current_user_can(['create_member', 'read_member', 'update_member', 'delete_member'])
                || current_user_can(['create_period', 'read_period', 'update_period', 'delete_period'])
                || current_user_can(['create_division', 'read_division', 'update_division', 'delete_division'])
                || current_user_can(['create_position', 'read_position', 'update_position', 'delete_position'])
                || current_user_can(['create_staff', 'read_staff', 'update_staff', 'delete_staff']))
            <li class="menu menu-heading">
