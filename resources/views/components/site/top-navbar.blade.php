...
<div class="flex justify-between items-center px-6 py-6 uppercase font-semibold" id="navbar">
    ...
    <div class="invisible lg:visible">
        <ul class="flex items-center">
            ...
            <li
                class="px-5 {{ request()->is('struktur') ? 'text-gray-50' : 'text-dark-blue-400' }} hover:text-gray-50">
                <a href="{{ route('struktur') }}">Struktur</a>
            </li>
            <li class="px-5 {{ request()->is('galeri') || request()->is('galeri/*') ? 'text-gray-50' : 'text-dark-blue-400' }} hover:text-gray-50">
