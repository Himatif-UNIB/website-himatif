...
<body class="bg-dark-blue">
    ...
    <div class="my-36 max-w-3xl mx-auto space-y-4">
        <div class="w-full h-auto px-6 py-5 bg-gray-100 rounded-md border-t-8 border-orange-500">
            ...
            <p class="my-3 text-dark-blue-800">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, optio
                illum, a cum debitis harum, autem dolore quaerat quia quasi quod? Quasi dolor ipsa, tempore sapiente
                nemo eaque suscipit repellat.</p>
        </div>
        ...
        <div class="w-full h-auto px-6 py-5 bg-gray-100 rounded-md">
            ...
            <div class="mt-4">
                <textarea
                    class="w-full h-auto bg-gray-100 focus:outline-none border border-dark-blue-400 rounded-md p-3"
        ...
        <div class="text-center mt-4">
            <a href="{{ route('form.submit') }}"
                class="font-semibold text-lg bg-orange-500 rounded-md px-6 py-1 text-white hover:bg-orange-600 focus:outline-none">Kirim</a>
        </div>
